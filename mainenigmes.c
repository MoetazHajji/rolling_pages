...
ecran=SDL_SetVideoMode(1000, 800, 32,SDL_ANYFORMAT); // Ouverture de la fenêtre
backg = IMG_Load("history.png");
positiond.x=0 ; 
positiond.y=0 ; 
SDL_BlitSurface(backg,NULL, ecran, &positiond);
SDL_Flip(ecran);
texte=TTF_RenderText_Blended(police,"good unswer=++score",couleurnoir);
